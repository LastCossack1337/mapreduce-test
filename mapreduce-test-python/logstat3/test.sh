...
/usr/local/hadoop/bin/hdfs dfs -mkdir -p /c/Users/smykh/Desktop/testfolder
...
/usr/local/hadoop/bin/hdfs dfs -cat /logstat3/output/part-00000 > /c/Users/smykh/Desktop/testfolder
/usr/local/hadoop/bin/hdfs dfs -rm -r /logstat3/input/
/usr/local/hadoop/bin/hdfs dfs -rm -r /logstat3/output/
../../stop.sh